...
OPTIMIZATION = s
TARGET       = main
SRC          = $(TARGET).c Descriptors.c Board/Hardware.c Board/commands.c $(COMMON_PATH)/command.c $(COMMON_PATH)/dfu_jump.c $(COMMON_PATH)/mem_usage.c version.c $(LUFA_SRC_USB) $(LUFA_SRC_USBCLASS)
